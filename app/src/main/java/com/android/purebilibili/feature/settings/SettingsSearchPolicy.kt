...
private val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry(
        ...
        subtitle = "交互",
        section = "播放设置",
        aliases = listOf("自动连播", "自动播放下一个", "进入视频自动播放", "进入视频不要自动播放", "不要自动播放", "双击点赞", "双击跳转", "取消双击跳转", "关闭双击跳转", "双击快进", "双击后退", "快进秒数", "后退秒数", "关注点赞弹幕", "关注弹幕", "点赞弹幕", "三连弹幕", "弹幕屏蔽", "字幕", "自动启用字幕", "ai总结", "视频简介", "默认展开视频简介", "简介默认展开", "播放器缩小策略", "竖屏视频缩小", "横屏视频缩小", "上滑隐藏播放器", "点击视频直接播放"),
    ...
    SettingsSearchEntry(
        ...
        subtitle = "交互",
        section = "播放设置",
        aliases = listOf("自动横竖屏", "自动旋转", "全屏方向", "固定全屏比例", "全屏手势反向", "自动进入全屏", "自动退出全屏", "横屏适配", "平板评论区宽度", "评论区宽度", "评论折叠数量", "评论回复预览", "评论预览数量", "评论检测", "发评反诈", "评论发送检测", "评论装扮", "个性装扮", "评论区个性装扮", "图片长按保存", "长按保存图片", "查看图片保存", "播放页隐藏状态栏", "隐藏状态栏", "状态栏"),
