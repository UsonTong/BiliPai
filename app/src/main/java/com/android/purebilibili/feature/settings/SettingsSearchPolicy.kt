...
private val SETTINGS_SEARCH_INDEX: List<SettingsSearchEntry> = listOf(
    ...
    SettingsSearchEntry(
        ...
        subtitle = "交互",
        section = "播放设置",
        aliases = listOf("自动横竖屏", "自动旋转", "全屏方向", "固定全屏比例", "全屏手势反向", "自动进入全屏", "自动退出全屏", "横屏适配", "平板评论区宽度", "评论区宽度", "评论折叠数量", "评论回复预览", "评论预览数量", "评论检测", "发评反诈", "评论发送检测", "评论装扮", "个性装扮", "评论区个性装扮", "播放页隐藏状态栏", "隐藏状态栏", "状态栏"),
